  ...
  return (
    <div style={{ padding: '52px 24px 90px' }}>
      ...
      <button onClick={handleGoogle} style={{
        ...
        <span style={{ fontSize: 12, fontWeight: 700, color: T.ink, letterSpacing: '0.1em', textTransform: 'uppercase', fontFamily: T.sans }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '16px 0' }}>
        ...
        <span style={{ fontSize: 10, color: T.faint, letterSpacing: '0.1em', textTransform: 'uppercase' }}>or</span>
        <div style={{ flex: 1, height: 1, background: 'rgba(74,53,40,0.15)' }} />
      </div>
