...
// The sign-up sheet as it was before phone sign-up: email, password and a
// username, with a Sign up / Sign in toggle. It only appears when the admin
// page's sign-up switch is set to email (app/admin), the fallback for texts
// not getting through; components/SignUpSheet.tsx picks between the two and
// explains what the sheet is for.
export function EmailSignUpSheet({
